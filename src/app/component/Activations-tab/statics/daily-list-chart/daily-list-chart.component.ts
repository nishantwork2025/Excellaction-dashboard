...
@Component({
    selector: 'app-daily-list-chart',
    standalone: true,
    imports: [RouterLink, MatCardModule, MatButtonModule, MatMenuModule, NgApexchartsModule],
    templateUrl: './daily-list-chart.component.html',
    styleUrl: './daily-list-chart.component.scss'
  })
  export class DailyListChartComponent {
    ...
    updateChartData(timeframe: string) {
        ...
        switch (timeframe) {
            case 'This Day':
                ...
                series = [
                    { name: "Smart key", data: [5, 10, 15, 8] },
                    { name: "Regular key", data: [2, 5, 10, 12] },
            ...
            case 'This Week':
                ...
                series = [
                    { name: "Smart key", data: [20, 25, 30, 28, 35, 40, 50] },
                    { name: "Regular key", data: [15, 18, 22, 20, 25, 30, 35] },
            ...
            case 'This Month':
                ...
                series = [
                    { name: "Smart key", data: Array.from({ length: 30 }, () => Math.floor(Math.random() * 50) + 10) },
                    { name: "Regular key", data: Array.from({ length: 30 }, () => Math.floor(Math.random() * 40) + 5) },
            ...
            case 'This Year':
                ...
                series = [
                    { name: "Smart key", data: [280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500] },
                    { name: "Regular key", data: [240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460] },
