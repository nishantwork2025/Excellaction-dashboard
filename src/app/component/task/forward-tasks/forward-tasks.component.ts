...
@Component({
    selector: 'app-forward-tasks',
    standalone: true,
    imports: [RouterLink, MatCardModule, MatButtonModule, MatMenuModule, MatPaginatorModule, MatTableModule, NgIf,StatsComponent],
    templateUrl: './forward-tasks.component.html',
    styleUrl: './forward-tasks.component.scss'
  })
  export class ForwardTasksComponent  {
