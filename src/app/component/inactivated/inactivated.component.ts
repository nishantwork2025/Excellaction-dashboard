...
import { DrpComparisonRangesComponent } from '../../ui-elements/datepicker/drp-comparison-ranges/drp-comparison-ranges.component';
import { DrpwcaSelectionStrategyComponent } from '../../ui-elements/datepicker/drpwca-selection-strategy/drpwca-selection-strategy.component';
import { FeathericonsComponent } from '../../icons/feathericons/feathericons.component';
import { FeathericonsModule } from '../../icons/feathericons/feathericons.module';

@Component({
    selector: 'app-inactivated',
    standalone: true,
    imports: [ FeathericonsModule ,RouterLink, MatCardModule, MatButtonModule, MatMenuModule, MatPaginatorModule, MatTableModule, NgIf,DrpwcaSelectionStrategyComponent],
    templateUrl: './inactivated.component.html',
    styleUrl: './inactivated.component.scss'
  })
  export class InactivatedComponent{
